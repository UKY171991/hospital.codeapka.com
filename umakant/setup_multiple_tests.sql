-- =====================================================
-- MULTIPLE TESTS PER ENTRY - COMPLETE SETUP SQL
-- =====================================================
-- Run this SQL script to enable multiple tests per entry functionality
-- This script is safe to run multiple times (uses IF NOT EXISTS)

-- Step 1: Create the entry_tests junction table
-- =====================================================
...
-- Step 2: Modify entries table to support multiple tests
-- =====================================================
ALTER TABLE entries 
...
-- Step 3: Create useful views for querying
-- =====================================================

-- View for entries with all their test information
...
-- View for individual test results within entries
...
-- Step 7: Sample data (optional - uncomment if you want test data)
-- =====================================================
/*
...
-- Check if multiple tests setup is working
-- SELECT 
--     COUNT(*) as total_entries,
--     SUM(CASE WHEN grouped = 1 THEN 1 ELSE 0 END) as multiple_test_entries,
--     SUM(CASE WHEN grouped = 0 THEN 1 ELSE 0 END) as single_test_entries
-- FROM entries;

-- =====================================================
-- SETUP COMPLETE!
-- =====================================================
-- Your database is now ready for multiple tests per entry functionality.
-- You can now use the entry page to add multiple tests to a single entry.

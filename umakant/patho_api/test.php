...
$entity_config = [
    ...
    'list_fields' => 't.id, t.name, t.price, t.method, t.test_code, t.added_by, u.username as added_by_username, t.created_at, c.name as category_name, mc.name as main_category_name',
...
function handleList($pdo, $config, $user_data, $isSimpleList = false) {
    ...
    if ($isSimpleList) {
        $stmt = $pdo->query("SELECT t.id, t.name, t.price, c.name as category_name, mc.name as main_category_name 

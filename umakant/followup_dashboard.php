...
<style>
    ...
    .ui-datepicker-header { background: #3b82f6; border: none; border-radius: 8px; color: #fff; }
    .ui-datepicker-calendar .ui-state-active { background: #3b82f6 !important; border-color: #3b82f6 !important; border-radius: 4px; }
</style>';
